...
| 類型 | 來源 | 方式 | 已知限制 |
|---|---|---|---|
| 綜合新聞 | 中央社、ETtoday、聯合新聞網、自由時報、中時、NOWnews、風傳媒、壹蘋、TVBS、三立、Yahoo奇摩 | RSS | 部分 RSS 網址可能隨改版失效,失敗會列入報告資料缺口 |
| 綜合新聞 | LINE Today | — | 無公開 RSS 且限制爬取,**無法自動抓取**,僅提供入口連結 |
| 財經專業 | Anue鉅亨、經濟日報、工商時報、MoneyDJ | RSS | 經濟日報部分內容訂閱制,僅取公開標題+摘要 |
| 深度雜誌 | 商業周刊、今周刊、天下、遠見 | RSS | 全文多為**付費牆**,僅取公開標題+摘要並於資料中保留原文連結 |
| 科技新創 | 數位時代、科技新報 | RSS | 科技新報 robots.txt 不允許機器抓取,系統依規範跳過並標示缺口 |
